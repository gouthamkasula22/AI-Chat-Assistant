...
class GeminiStrategy(AIModelStrategy):
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        config = ModelConfig(
            ...
            model_id="gemini-pro",
            description="Google's Gemini Pro - Fast and capable conversational AI",
            max_tokens=2048,
            temperature=0.7,
    ...
    def generate_response(self, messages: List[Dict[str, str]], 
        ...
        try:
            ...
            return self.handle_error(e, "Gemini API request failed")
        except Exception as e:
            return self.handle_error(e, "Unexpected error in Gemini strategy")
